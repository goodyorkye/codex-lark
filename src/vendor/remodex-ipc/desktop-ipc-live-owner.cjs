// Modified from Remodex; licensed under Apache-2.0. See THIRD_PARTY_NOTICES.md.
...
} = require("./desktop-ipc-shared.cjs");
const {
  LOCAL_HOST_ID,
...
} = require("./desktop-ipc-conversation-adapter.cjs");
const {
  DEFAULT_MAX_PATCH_BYTES,
  DEFAULT_MAX_PATCH_COUNT,
  applyPatchesToBaselineState,
  buildConversationStatePatches,
} = require("./desktop-ipc-state-patches.cjs");
const {
  createDesktopOwnerIpcClient,
} = require("./desktop-ipc-owner-transport.cjs");
